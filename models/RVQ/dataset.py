...
class action_tokenize_dataset_n(Dataset):
    def __init__(self, step_ahead, mode='None'):
        ...
        if mode == 'separate' or mode == 'None':
            file_path="/dingpengxiang/Pengxiang/Quart++/datasets/Full/sim_quadruped_data_info/vq_data_step_"+str(self.step_ahead)+'.npy'
        else:
            file_path="/dingpengxiang/Pengxiang/Quart++/datasets/Full/sim_quadruped_data_info/vq_data_step_"+str(self.step_ahead)+'_each.npy'
