#This file is for processing the vq json code for quart-online training using trained .pt model
import sys
import os
...
def make_vq_json(sim_instruction_dict, ranges_info_path, commands_info_path, json_path, sim_path, sample_rate, ahead_step):
    ...
    for task in tqdm(task_list):
        print("task is:",task)
        json_list = []
        json_list = single_task_json_vq_core(sim_path, commands_info_path, task, range_dict, json_list, image_id, sample_rate, ahead_step, json_saved_path)
